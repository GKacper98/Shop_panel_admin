...
if (isset($_POST['order_btn'])) {
    ...
    $cart_total = 0;
    $cart_product = array(); // Initialize as an array
    ...
    $total_products = implode(', ', $cart_product); // Use implode on the array
...
<div class="banner">
        <div class="detail">
            ...
            <center><a href="index.php">home</a><span>contact</span></center>
        </div>
    </div>
        ...
        <?php
            ...
            <form method="post">
                ...
                <div class="input-field">
                    ...
                    <input type="text" name="pin" placeholder="e.g 111222">
                </div>
